...
MultiThreadedTCPServer::MultiThreadedTCPServer(const std::string & _srvName, const std::string & _bindAddress,
...
TCPConnectionManager & MultiThreadedTCPServer::connectionManager() {
    return *(connMgr.get());
}
